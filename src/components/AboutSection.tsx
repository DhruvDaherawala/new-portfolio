    ...
    <section id="about" className="min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 relative">
      ...
      <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 max-w-4xl w-full relative z-10">
        <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 w-full">
          ...
          <AnimatedText
            text="I am a Full Stack Developer with hands-on experience in Artificial Intelligence, Machine Learning, MERN Stack, Django, and Next.js. I build production-grade web applications, AI-powered systems, and mobile applications."

    ...
    <section className="h-screen flex flex-col overflow-y-visible relative" style={{ overflowX: 'clip' }}>
      <div className="flex flex-col flex-1 px-5 sm:px-8 md:px-10 relative z-0">
        ...
        <FadeIn delay={0.15} y={40} className="mt-6 sm:mt-4 md:-mt-5 overflow-hidden">
          <h5
            className="hero-heading font-black uppercase leading-none tracking-tight whitespace-nowrap w-full text-[14vw] sm:text-[15vw] md:text-[16vw] lg:text-[15vw]"
          >
            Hi, i&apos;m Dhruv
          </h5>
        </FadeIn>
